...
export interface FeedbackSuccessProps extends StackScreenProps<MainStackParamList, 'FeedbackSuccess'>{}

const FeedbackSuccessScreen: FC<FeedbackSuccessProps> = ({ navigation }) => (
    ...
    <Container paddingSize={ 8 }>
      ...
      >
        ...
        <Typography
          ...
          text="Ваше обращение успешно отправлено, ожидайте ответ на эл. почте"
          color="#999999"
          ml={ 8 }
          mb={ 16 }
          regular
